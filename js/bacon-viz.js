...
(function() {
  ...
  visualize = function(streamName, $streamsContainer) {
    var vis;
    vis = BaconViz.createStreamVisualization(streamName,$streamsContainer);
...
(function() {
  ...
  BaconViz.createStreamVisualization = function(streamName, $streamsContainer) {
    var $newStream, $streamsContainer, $svg, chart;
    if($streamsContainer == undefined) {
